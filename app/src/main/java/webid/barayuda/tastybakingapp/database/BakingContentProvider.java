package webid.barayuda.tastybakingapp.database;
...
import static webid.barayuda.tastybakingapp.database.contract.StepContract.StepEntry;

import static webid.barayuda.tastybakingapp.database.contract.IngredientContract.IngredientEntry;

import static webid.barayuda.tastybakingapp.database.contract.RecipeContract.RecipeEntry;

import static webid.barayuda.tastybakingapp.database.contract.IngredientContract.PATH_INGREDIENTS;
import static webid.barayuda.tastybakingapp.database.contract.RecipeContract.PATH_RECIPES;
import static webid.barayuda.tastybakingapp.database.contract.StepContract.PATH_STEPS;
import static webid.barayuda.tastybakingapp.util.Constant.AUTHORITY;

/**
 * Created by BARAYUDA on 6/30/2017.
 */
